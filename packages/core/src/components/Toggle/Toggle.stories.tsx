...
export const GroupSingle: Story = { name: 'Toggle.Group · single (alignment)', render: () => <Alignment /> };
export const GroupFormatting: Story = {
    name: 'Toggle.Group · multiple (B/I/U/S)',
    render: () => <TextFormatting />,
};
export const GroupViewSwitcher: Story = {
    name: 'Toggle.Group · view mode',
    render: () => <ViewMode />,
};
