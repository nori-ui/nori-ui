...
function readModules(): Record<string, CsfModule> {
    ...
    try {
        ...
        if (meta && typeof meta.glob === 'function') {
            ...
            const modules = (import.meta as any).glob('../components/**/*.stories.tsx', { eager: true }) as Record<string, CsfModule>;
...
export function buildComponents(modules: Record<string, CsfModule>): ComponentEntry[] {
    ...
    for (const path of Object.keys(modules)) {
        ...
        for (const key of Object.keys(mod)) {
            ...
            const story = mod[key] as { args?: Record<string, unknown>; render?: (a: Record<string, unknown>) => unknown } | undefined;
            ...
            const Render: ComponentType<Record<string, never>> = renderFn
                ? () => renderFn(mergedArgs) as ReturnType<ComponentType>
                : Component
